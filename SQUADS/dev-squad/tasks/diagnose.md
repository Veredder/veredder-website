...
Checklist:
  - "[ ] User intent parsed and complexity assessed"
  - "[ ] Cross-cutting answer delivered to user"
  - "[ ] Routing suggestion provided"
---

# Task: Diagnose & Route — Dev Squad

## Metadata

| Field         | Value                                   |
|---------------|-----------------------------------------|
| Task ID       | `dev-squad:diagnose`                    |
| Command       | `@dev-squad` or `@dev-squad:dev-chief`  |
| Orchestrator  | `dev-chief`                             |
| Version       | 1.0.0                                   |
| Created       | 2026-04-11                              |

## Purpose

Analyze the user's development question, provide an immediate cross-cutting answer,
...
2. Identify keywords, technology domains, and technical context
3. Determine request category: architecture, implementation, refactoring, testing, performance, debugging, or design
4. Assess complexity: SIMPLE (single domain), STANDARD (2-3 domains), COMPLEX (cross-cutting)
...
3. Include relevant context: patterns, quick guidance, best practices
4. This answer must stand alone — even if the user never follows the routing suggestion
...
diagnosis:
  ...
  category: "architecture | implementation | refactoring | testing | performance | debugging | design"
